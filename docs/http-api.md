...
10	Incoming SMS or SMS answer (contact us for more details)
 ...
 5 	Document copyright
This document can be totally or partially reproduced, stored, recovered, or transmitted by electronical or mechanical means, photocopied or published in any other form, only with the previous consent of the authors and in the terms they will state. Copyright © TOPefekt s.r.o.
